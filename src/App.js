...
function App() {
 ...
 const handleMax = (e) => {
  ...
  console.log('La valeur de cpt (out) est : ' + cpt);
  console.log('La valeur de pas (out) est : ' + pas);
  console.log('La valeur de Min (out) est : ' + min);
  console.log('La valeur de Max (out) est : ' + max);

  const handleDecrement = () => {
    console.log('La valeur de cpt (in) est : ' + cpt);
    console.log('La valeur de pas (in) est : ' + pas);
    console.log('La valeur de Min (in) est : ' + min);
   console.log('La valeur de Max (in) est : ' + max);
